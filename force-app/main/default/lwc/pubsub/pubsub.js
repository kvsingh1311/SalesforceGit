...
const register = (eventName, callback) => {
    alert('----Register---Event Name----'+JSON.stringify(eventName));
    alert('----Register---Event Name----'+callback);
...
const unregister = (eventName, callback) => {
    alert('----Unregister---Event Name----'+JSON.stringify(eventName));
    alert('----Unregister---Event Name----'+JSON.stringify(callback));
  if (callbacks[eventName]) {
...
const fire = (eventName, payload) => {
    alert('----Fire---Event Name----'+JSON.stringify(eventName));
    alert('----Fire---Event Name----'+callback);
  if (callbacks[eventName]) 
  {
